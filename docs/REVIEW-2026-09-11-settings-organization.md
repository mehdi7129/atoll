...
il a demandé la fusion et la release : PR #4 fusionnée, **v0.18.2/build 37 publiée**.
[HANDOFF](HANDOFF.md) porte l'état courant et les [preuves de livraison](releases/0.18.2.json).
Les mesures ci-dessous sont celles du code `e50e269`, conservé pour la release.

## Organisation livrée en v0.18.2
